...
import com.happynetwork.common.utils.HXPreferenceUtils;
import com.happynetwork.vrestate.beans.User;
import com.happynetwork.vrestate.widget.HXSDKHelper;

public class UserProfileManager {

	protected static final String TAG = "UserProfileManager";
	...
	public void addSyncContactInfoListener(HXSDKHelper.HXSyncListener
												   listener) {
		if (listener == null) {
			return;
		}
