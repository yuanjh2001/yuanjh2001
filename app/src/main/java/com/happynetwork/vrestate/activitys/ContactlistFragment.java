...
import com.happynetwork.vrestate.adapters.ContactAdapter;
...
import com.happynetwork.vrestate.widget.Sidebar;
...
public class ContactlistFragment extends Fragment implements OnClickListener{
	public static final String TAG = "com.longwan.chatuidemo";
	...
	class HXBlackListSyncListener implements HXSDKHelper.HXSyncListener {
        ...
        public void onSyncSucess(boolean success) {
			mActivity.runOnUiThread(new Runnable(){
                ...
                @Override
                public void run() {
					EMLog.d(TAG, "HXBlackListSyncListener:====");
                    blackList = EMContactManager.getInstance().getBlackListUsernames();
                    refresh();
					EMLog.d(TAG, "HXBlackListSyncListener refresh after:success");
                }
...
//		}
	...
	private void getContactList() {
		...
		EMLog.d(TAG, "getContactList:success" );
	}
	...
	public void onSaveInstanceState(Bundle outState) {
		...
		EMLog.d(TAG, "onSaveInstanceState:=====" );
	    if(((ContactListActivity)mActivity).isConflict){
	    	outState.putBoolean("isConflict", true);
	    }else if(((ContactListActivity)mActivity).getCurrentAccountRemoved()){
