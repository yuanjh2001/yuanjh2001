 ...
 *     --ei inputType 2
 */
public class SimpleVrVideoActivity extends BaseActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    addContentViewBelowTitleBar(R.layout.activity_vrplayer);
    setTitleName("播放vr视频");
  ...
  protected void onNewIntent(Intent intent) {
    LogUtils.i(this.hashCode() + ".onNewIntent()");
  ...
  private void handleIntent(Intent intent) {
    ...
    if (Intent.ACTION_VIEW.equals(intent.getAction())) {
      LogUtils.i( "ACTION_VIEW Intent received");

      fileUri = intent.getData();
      if (fileUri == null) {
        LogUtils.w( "No data uri specified. Use \"-d /path/filename\".");
      } else {
        LogUtils.i("Using file " + fileUri.toString());
      }
      ...
      LogUtils.i("Intent is not ACTION_VIEW. Using the default video.");
      fileUri = null;
    }
  ...
  private class ActivityEventListener extends VrVideoEventListener {
    ...
    public void onLoadSuccess() {
      LogUtils.i("Sucessfully loaded video " + videoWidgetView.getDuration());
    ...
    public void onLoadError(String errorMessage) {
      ...
      Toast.makeText(
          ...
          .show();
      LogUtils.e( "Error loading video: " + errorMessage);
    }
  ...
  class VideoLoaderTask extends AsyncTask<Pair<Uri, Options>, Void, Boolean> {
    ...
    protected Boolean doInBackground(Pair<Uri, Options>... fileInformation) {
      try {
        ...
        LogUtils.e("Could not open video: " + e);
      }
