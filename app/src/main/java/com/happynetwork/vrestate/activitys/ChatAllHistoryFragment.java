...
import com.happynetwork.vrestate.adapters.ChatAllHistoryAdapter;
...
public class ChatAllHistoryFragment extends Fragment implements OnClickListener {
	...
	private ImageButton clearSearch,back;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		contact = (ImageView)getView().findViewById(R.id.contacts);
...
//		((MainActivity) getActivity()).updateUnreadLabel();
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if(((ChatAllHistoryActivity)getActivity()).isConflict){
        	outState.putBoolean("isConflict", true);
        }else if(((ChatAllHistoryActivity)getActivity()).getCurrentAccountRemoved()){
    ...
    public void onClick(View v) {       
        ...
        case R.id.back:
			...
			case R.id.contacts:
				...
				intent.setClass(mActivity,ContactListActivity.class);
				startActivity(intent);
				break;
