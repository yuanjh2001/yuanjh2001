...
public class UserUtils {
    ...
    public static void setUserAvatar(Context context, String username, ImageView imageView){
        ...
        if(user != null && user.getAvatar() != null){
            Picasso.with(context).load(user.getAvatar()).placeholder(R.mipmap.default_icon).transform(new CircleTransform()).into(imageView);
        }else{
            Picasso.with(context).load(R.mipmap.default_icon).transform(new CircleTransform()).into(imageView);
        }
    }
