	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ViewHolder holder;
 		if(convertView == null){
			...
			holder.contact_item = (RelativeLayout) convertView.findViewById(R.id.contact_item);
		...
		Log.i(TAG, "userNickName===="+user.getNick());
		//显示申请与通知item
		if(username.equals(Constant.NEW_FRIENDS_USERNAME)){
//		    holder.nameTextview.setText(user.getNick());
		    holder.nameTextview.setText(R.string.newneighbor);
		    holder.avatar.setImageResource(R.mipmap.social_new_neighbor);
			...
			//群聊item
		    holder.nameTextview.setText(user.getNick());
		    holder.avatar.setImageResource(R.mipmap.social_group);
		}else if(username.equals(Constant.CHAT_ROOM)){
            //群聊item
//            holder.nameTextview.setText(user.getNick());
//            holder.avatar.setImageResource(R.drawable.groups_icon);
		    holder.contact_item.setVisibility(View.GONE);
