...
/**
 * Created by Tom.yuan on 2016/10/25.
 */
...
public class CheckPermisionUtil {
    ...
    private static int getPermisionResult(Context context, int permValue,String methodName) {
        int check = 0;
        try {
            ...
            e.printStackTrace();
            LogUtils.w("--->getPermisionResult exception");
        }catch (Error er){
            LogUtils.w(er.toString());
        }
        return check;
    }
